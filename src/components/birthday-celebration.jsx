  ...
  return (
    <div className="flex flex-col items-center">
      ...
      >
        ...
        <h3 className="text-2xl sm:text-3xl font-bold text-center text-pink-600 mt-2">To You Binika Thapa.</h3>
      </motion.div>
      ...
      >
        ...
        >
          ...
          >
            ...
            <div className="text-center text-white">
              <p className="text-lg font-medium mb-4">Tap to {isCardOpen ? "close" : "open"} your own beautiful photos.</p>
              ...
              >
                <div className="text-center">
                  ...
                  <div className="flex justify-center">
                    ...
                    >
                      loading...<Heart className="w-8 h-8 stroke-none fill-rose-500" />
                    </motion.div>
                  </div>
                </div>
              </motion.div>
        ...
        </div> {/* ✅ closes relative clickable div */}
      </motion.div>
      ...
      >
        <div className="text-center">
          <p className="text-lg text-purple-700 mb-4">
            ...
            The soul behind them that I’ll always admire,,<br />
            And the person I’ll always be here to support — no matter the distance.
          </p>
          <div className="flex justify-center items-center gap-2">
            <p className="text-pink-600 font-medium">
              I hope your wish and desires will fuilful by me🫶
            </p>
          </div>
        </div>
      </motion.div>
